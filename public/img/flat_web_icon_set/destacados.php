...
if($banner != null){
	...
	if($banner["estado"] != 0){
		...
		echo '<figure class="banner">
					...
					<h3 class="bannerPrincipal"><a href="https://techosymantenimientos.com.mx/portafolio" style="color:white;">VISITA NUESTRO PORTAFOLIO</a></h3>
...
$titulosModulos = array("LO MÁS COTIZADO", "LO MÁS VISTO", "LO MÁS VENDIDO");
$rutaModulos = array("lo-mas-cotizado", "lo-mas-visto", "lo-mas-vendido");

$base = 0;
$tope = 4;

if($titulosModulos[0] == "LO MÁS COTIZADO"){
...
$cotizar = ControladorProductos::ctrMostrarProductos($ordenar, $item, $valor, $base, $tope, $modo);
...
$modulos = array($cotizar, $vistas, $ventas, $translucidos); //gratis
