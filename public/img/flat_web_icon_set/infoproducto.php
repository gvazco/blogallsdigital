		...
		<div class="row">
			...
			?>
				...
				<?php
					...
					echo '<p style="font-size:1.2em; text-align:justify">'.$infoproducto["descripcion"].'</p>';
					...
					if($infoproducto["detalles"] != null){
						...
						if($infoproducto["tipo"] == "fisico"){
							...
							echo '<div class="col-xs-12">
								...
								<li> 
									<i style="margin-right:10px" class="fa fa-industry"></i> '.$detalles["Ficha"].'
								</li>
								<li>
									<i style="margin-right:10px" class="fa fa-arrows-alt"></i> '.$detalles["Largos"].'
								</li>
								<li>
									<i style="margin-right:10px" class="fa fa-expand"></i> '.$detalles["Calibre"].'
								</li>
								<li>
									<i style="margin-right:10px" class="fa fa-truck"></i> '.$detalles["Envio"].'
								</li>
								<li>
									<i style="margin-right:10px" class="fa fa-exclamation-circle"></i>'.$detalles["Info"].' 
								</li>
							...
							echo '<div class="col-xs-12">
								...
								<li> 
									<i style="margin-right:10px" class="fa fa-industry"></i> '.$detalles["Formato"].'
								</li>
								<li>
									<i style="margin-right:10px" class="fa fa-arrows-alt"></i> '.$detalles["Paginas"].'
								</li>
								<li>
									<i style="margin-right:10px" class="fa fa-exclamation-circle"></i>'.$detalles["Info"].' 
								</li>
						...
						if($infoproducto["tipo"]=="cotizar"){
								...
								echo '<div class="col-md-6 col-xs-12">';
										...
										echo '<a class="cotizarProducto" href="#modalCotizar" data-toggle="modal" idCotizar="">
											...
											<button class="btn btn-block btn-lg btn-default backColor pull-left cotizar">SOLICITAR COTIZACIÓN <i class="fa fa-comments"></i></button>
...
======================================-->
  ...
  <div id="modalCotizar" class="modal fade modalFormulario" role="dialog">

    <div class="modal-content modal-dialog">

        <div class="modal-body modalTitulo">

        	<h3 class="backColor">COTICE SUS PRODUCTOS</h3>

        	<button type="button" class="close" data-dismiss="modal">&times;</button>
			
			<form method="post" onsubmit="return validarCotizacion()">

				<input type="hidden" value="" id="idCotizar" name="idCotizar">

				  <h3 class="text-center"><small>DEBIDO A OSCILACIONES EN EL TIPO DE CAMBIO ($MXN-$MXN), DEBEMOS COTIZAR SUS PRODUCTOS</small></h3>
				  
				  <h4 class="text-center"><small>PARA SU MEJOR ATENCIÓN, FAVOR DE RELLENAR LOS SIGUIENTES CAMPOS:</small></h2>
				  ...
				  <?php  
				    ...
				    if(isset($_SESSION["validarSesion"])){
						...
						if($_SESSION["validarSesion"] == "ok"){
								...
								echo '<div class="input-group">
									      ...
									      <input id="nombreCotizar" type="text" class="form-control" name="nombreCotizar" placeholder="Escriba su Nombre:" value="'.$_SESSION["nombre"].'">
									    </div>
								...
								echo '<div class="input-group">
								      <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
								      <input id="nombreCotizar" type="text" class="form-control" name="nombreCotizar" placeholder="Escriba su Nombre:" value="" required>
								    </div>
				    ...
				    if(isset($_SESSION["validarSesion"])){
						...
						if($_SESSION["validarSesion"] == "ok"){
								...
								echo '<div class="input-group">
								      <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
								      <input id="emailCotizar" type="email" class="form-control" name="emailCotizar" placeholder="Escriba su Correo Electrónico:" value="'.$_SESSION["email"].'">
								    </div>
								...
								echo '<div class="input-group">
								      <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
								      <input id="emailCotizar" type="email" class="form-control" name="emailCotizar" placeholder="Escriba su Correo Electrónico:" value="" required>
								    </div>
				    ...
				    echo '<div class="input-group">
				    	...
				    	<input id="tituloCotizar" type="text" class="form-control" name="tituloCotizar" placeholder="" value="'.$infoproducto["titulo"].'
				    	">
				    </div>';
				    ...
				    <span><small>*Si usted no desea ingresar su número, le enviaremos un e-mail</small></span>
				    ...
				    <div class="input-group">
				  	    <span class="input-group-addon">Piezas requeridas:</span>
				    ...
				    <span><small>*Si usted no lo sabe con certeza, responda el siguiente campo.</small></span>

				    <br><br>

				    <div class="input-group">
				  	    <span class="input-group-addon">Metros cuadrados:</span>
				    	<input id="areaCotizar" type="text" class="form-control" name="areaCotizar" placeholder="¿Cuál es el área (mts2 y/o lineales) de su proyecto?" value="">
				    </div>

				    <br>

				    <div class="input-group">
				  	    <span class="input-group-addon">Lugar de envio:</span>
				    	<input id="direccionCotizar" type="text" class="form-control" name="direccionCotizar" placeholder="Ingrese el estado y municipalidad de la entrega" value="">
				    </div>

				    <br>

				    <div class="form-group">
						<label for="comment" class="text-muted">¿Tiene dudas o comentarios acerca de su material?: <span><small>Campo Obligatorio, máximo 600 caracteres.</small></span></label>
				  ...
				  <?php
				  	...
				  	$cotizacion = new ControladorUsuarios();
				  	$cotizacion -> ctrFormularioCotizacion();

				  ?>

				  <h4 class="text-center"><small>EN <b>MEVASA</b> NOS ESFORZAMOS POR BRINDARLE SERVICIO Y CALIDAD ¡AL MEJOR PRECIO!</small></h4>
